<?php 
    if (isset($_GET["username"]) == true && !empty($_GET["username"]) == true) {
			...
			<ul>
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo BASE_URL.$user->profile_image; ?>"><?php echo $user->username; ?></a></li>
		...
		<ul>
            ...
            <?php if (!empty($profileData->website)) { ?>
                <li>
                    ...
                    <div class="profile-ex-location">
                        <a href="<?php echo $profileData->website; ?>" target="_blank" rel="noopener noreferrer"><?php echo $profileData->website; ?></a>
                    </div>
                </li>
            <?php } ?>
